...
import 'models.dart';
import 'screens/startChallengeScreen.dart';
        ...
        return Positioned(
          ...
          child: GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(
              builder: (context) {
                //Go To select Quest Screen if state is not in quest
                if (BlocProvider.of<MainBloc>(context).state is ImLaden) {
                  return StartChallengeScreen(re["detectedClass"]);
                }
                //If already in quest
